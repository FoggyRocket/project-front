...
import { deleteProperty, getPropertiesByUser } from '../../services/propertyWs';
import { deleteReservation, getUserReservations } from '../../services/reservationWs';
              ...
              <div className="uk-width-expand">
                <div className="uk-padding-large uk-padding-remove-top uk-padding-remove-bottom">
                  ...
                  >
                    ...
                    <li>
                      {userReservations != null ? denormalizeData(userReservations).map(
                        (reservation, index) => (
                          <SimpleCard
                            key={index}
                            isReservation
